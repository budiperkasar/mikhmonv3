...
if($getsprice == "300"){ $color = "#666";} // jika harga == "1000" maka warna = "#01579B"
elseif($getsprice == "300"){ $color = "#FF1493";}
elseif($getsprice == "4300"){ $color = "#8B008B";}
elseif($getsprice == "500"){ $color = "#666";}
elseif($getsprice == "600"){ $color = "#FF4500";}
elseif($getsprice == "700"){ $color = "#E65100";}
elseif($getsprice == "800"){ $color = "#228B22";}
elseif($getsprice == "900"){ $color = "#008000";}
elseif($getsprice == "310"){ $color = "#FF00FF";}
elseif($getsprice == "320"){ $color = "#E60C00";} 
elseif($getsprice == "330"){ $color = "#FF0000";} 
...
</style>        	            	            	            	            	            	            	            	            	            <table style="display: inline-block;border-collapse: collapse;border: 1px solid #0033FF;margin: 2.5px;width: 190px;overflow:hidden;position:relative;padding: 0px;margin: 2px;border: 1px solid #000000;">
<tbody>
<tr>
<td style="color:#0033FF;" valign="top">
...
Cek status dan Logout
Buka brouser ketik  : mywifi.id
</div>
</td>	
...
jangan buang sebelum habis  <b></b>
</div>
</td>
</tr>
</tbody>
